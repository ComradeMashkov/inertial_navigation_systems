...
-   At this stage the Coriolis acceleration is take into account when converting from Inertial Frame to Body Frame.
...
$$ \Delta m_1=\cos\frac{\omega h_{N3}}{2}$$ $$ \Delta m_2=-\omega_x\sin\frac{\omega h_{N3}}{2}$$ $$ \Delta m_3=-\omega_y\sin\frac{\omega h_{N3}}{2}$$ - Thus, we can recalculate general rotation quaternion:
